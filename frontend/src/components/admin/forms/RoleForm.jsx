...
const RoleForm = ({ initialData = {}, mode = 'add' }) => {
  ...
  const permissionsList = [
    ...
    { name: 'Company', path: 'settings/company', actions: ['create', 'update','view'] },
    { name: 'Site', path: 'settings/site', actions: ['create', 'update','view'] },
    { name: 'Delivery Zones', path: 'settings/delivery-zones'},
    { name: 'Mail', path: 'settings/mail', actions: ['create', 'update','view'] },
    { name: 'OTP', path: 'settings/otp', actions: ['create', 'update', 'view'] },
    { name: 'Notification', path: 'settings/notification', actions: ['create', 'update', 'view'] },
    { name: 'Notification Alert', path: 'settings/notification-alert', actions: ['create', 'update', 'view'] },
    { name: 'Social Media', path: 'settings/social-media', actions: ['create', 'update', 'view'] },
    { name: 'Cookies', path: 'settings/cookies', actions: ['create', 'update', 'view'] },
    { name: 'Analytics', path: 'settings/analytics', actions: ['create', 'update', 'view'] },
    { name: 'Theme', path: 'settings/theme', actions: ['create', 'update', 'view'] },
    ...
    { name: 'Sms Gateway', path: 'settings/sms-gateway', actions: ['create', 'update', 'view'] },
    { name: 'Payment Gateway', path: 'settings/payment-gateway', actions: ['create', 'update', 'view'] },
